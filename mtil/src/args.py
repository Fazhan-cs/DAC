...
def parse_arguments():
    ...
    parser.add_argument("--lora-paths", type=str, default=None)
    ...
    parser.add_argument(
        ...
        type=str,
        default="whole",
        choices=["whole", "text", "image", "image-fc", "image-fc-fixed", "fc", "adapter","lora"],
        help="Train mode to use.",
    )
    parser.add_argument("--data-location", type=str, default="./data")
    parser.add_argument("--resfile", type=str, default="./data")
